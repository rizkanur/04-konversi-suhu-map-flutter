...
import 'package:flutter_widget_map/widget/hasilKonversi.dart';
import 'package:flutter_widget_map/widget/input.dart';
import 'package:flutter_widget_map/widget/riwayat.dart';
import 'package:flutter_widget_map/widget/targetKonversi.dart';
import 'package:flutter_widget_map/widget/tombolKonversiSuhu.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: const Text('Konverter Suhu | Rizka Nur Cahyani - 2031710065'),
        ),
        body: Container(
